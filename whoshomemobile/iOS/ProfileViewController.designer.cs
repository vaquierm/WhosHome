...
namespace whoshomemobile.iOS
{
    ...
    partial class ProfileViewController
    {
        ...
        UIKit.UIButton FullNameActionButton { get; set; }

        [Outlet]
        [GeneratedCode ("iOS Designer", "1.0")]
        UIKit.UIButton FullNameCancelButton { get; set; }
        ...
        [Outlet]
        [GeneratedCode ("iOS Designer", "1.0")]
        UIKit.UIButton MacAddressActionButton { get; set; }

        [Outlet]
        [GeneratedCode ("iOS Designer", "1.0")]
        UIKit.UIButton MacAddressCancelButton { get; set; }
        ...
        [Outlet]
        [GeneratedCode ("iOS Designer", "1.0")]
        UIKit.UIButton PasswordActionButton { get; set; }

        [Outlet]
        [GeneratedCode ("iOS Designer", "1.0")]
        UIKit.UIButton PasswordCancelButton { get; set; }
